...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-[#f4f4f5] flex flex-col antialiased">
      ...
      <footer className="border-t border-[#27272a] bg-[#18181b] py-5 text-center text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-auto">
        KubeGuard platform &copy; {new Date().getFullYear()} • Secure by Design.
      </footer>
    </div>
  );
}